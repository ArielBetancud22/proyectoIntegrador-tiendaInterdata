...
public class MetodoPago {
    ...
    public void metodoPago(double compraTotal) {
        ...
        System.out.println("Ingrese opcion de método de pago: ");
        ...
        switch (opcionPago) {
            ...
            case 2 -> {
                ...
                if (respuesta == 1) {
                    ...
                    System.out.println("Anio de vencimiento: ");
                    fv = venc.nextInt();
                    Scanner numCvv = new Scanner(System.in);
                    System.out.println("CVV: ");
                    cvv = numCvv.nextInt();
                    System.out.println("La compra fue relaizada con exito, gracias por elegirnos\n");
                } else {
                    MetodoPago metodoP = new MetodoPago();
                    metodoP.metodoPago(compraTotal);
                }
